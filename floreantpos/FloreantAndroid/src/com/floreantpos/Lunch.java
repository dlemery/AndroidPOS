...
public class Lunch extends ListActivity {@Override
	
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		//setContentView(R.layout.beverageslayout);
		com.floreantpos.DBConnect.dataConnect("lunch.php");
	    ...
	    ListAdapter listAdapter = new SimpleAdapter(this, list, R.layout.lunchitem, columns, renderTo);
...
protected void onListItemClick(ListView l, View v, int position, long id)
{
	...
	AlertDialog foo = new AlertDialog.Builder(Lunch.this).create();
	foo.setTitle("Lunch");
	...
	foo.setButton("Buy", new DialogInterface.OnClickListener() {
		public void onClick(DialogInterface dialog, int which) {
			...
			{
				DBConnect.sendorder(TableLogin.gettable(), "LUNCH", TableLogin.getNickname(), foodName);
				if(DBConnect.Orderresponse.equalsIgnoreCase("1"))
				{
					AlertDialog success = new AlertDialog.Builder(Lunch.this).create();
				...
				{
					AlertDialog error = new AlertDialog.Builder(Lunch.this).create();
			...
			{
				AlertDialog badlogin = new AlertDialog.Builder(Lunch.this).create();
